...
public class InstantiationConversionCommandTests {
    ...
    public void testBouyerConversion() throws DeserialisationException {
        ...
        String expectedWorkName = PackageUtils.getPackagePath(getClass(), "bouyer.expected-instantiation.work");
    ...
    private void testConversion(String srcWorkName, String expectedWorkName) throws DeserialisationException {
        ...
        InstantiationConversionCommand command = new InstantiationConversionCommand();
